...
model_filename = 'model_cali_3month.hdf5'
testset_log_filename = 'model_cali_3month_test_set_log.txt'
training_dataset_fire_only_directory = '/home/capstone22/WildFIrePrediction/agni/preprocessing_scripts/preprocessed_data_fire_only/'
training_dataset_directory = '/home/capstone22/WildFIrePrediction/agni/preprocessing_scripts/preprocessed_data/'
testset_directory = '/home/capstone22/WildFIrePrediction/agni/preprocessing_scripts/preprocessed_data_test_set/'
...
#     X = tf.keras.layers.Flatten()(X)
    # X = tf.keras.layers.CuDNNLSTM(64)(X)
...
def parse_input_data_function(filename):
    ...
    # latest 6 instances to represent roughly 3 months
    histogram_data = histogram_data[:6, :, :, :]
